...
singularity exec ${enigma_prep_container} wget https://surfer.nmr.mgh.harvard.edu/pub/dist/mri_deface/face.gca.gz
singularity exec ${enigma_prep_container} wget https://surfer.nmr.mgh.harvard.edu/pub/dist/mri_deface/talairach_mixed_with_skull.gca.gz

echo "Unzipping defacing templates"
singularity exec ${enigma_prep_container} gunzip face.gca.gz
singularity exec ${enigma_prep_container} gunzip talairach_mixed_with_skull.gca.gz
